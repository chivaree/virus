...
settings = {
    ...
    "Respontag":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "ResponPM":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "message":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "comment":"𝕒𝕦𝕥𝕠 𝕝𝕚𝕜𝕖 𝕓𝕪 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "Wc":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "bye":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "add":"𝕥𝕙𝕒𝕟𝕜 𝕗𝕠𝕣 𝕒𝕕𝕕 𝕞𝕖 \n𝕓𝕪 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "kick":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "c":" 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖",
    "s":"",
    "userAgent": [
...
#==============================================================================#
                ...
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖』")
...
#-------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"「✮ 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖 ✮」")                    
...
#-----------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"✮ 𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖 ✮" +datetime.today().strftime('%H:%M:%S')+ "™") 
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『𝕡𝕚𝕞𝕔𝕙𝕒 𝕓𝕠𝕥𝕝𝕚𝕟𝕖』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
